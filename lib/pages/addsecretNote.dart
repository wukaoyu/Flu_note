...
class secretaddScreen extends StatefulWidget{
  @override
  _SecretPageState createState() =>_SecretPageState();
}
class _SecretPageState extends State<secretaddScreen>{
  int maxline;
  ...
  void insertNote(String title,String content) async{
    ...
    await noteSqlite.insert(new Note(notelistall[notelistall.length-1].id+1,title,content,userdata,"2"));
    //切记用完就close
